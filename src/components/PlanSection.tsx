const PlanSection = () => {
  const steps = [
    "Анализ: 30-60 активных из 300.",
    "Продукт: Гайд за 1000 руб. (30 продаж = 30к).",
    "Прогрев: 3 недели (знакомство → запуск).",
    "Трафик: +50-100 подписчиков.",
    "Контроль: Отслеживай и корректируй.",
  ];
