const SecretsSection = () => {
  const secrets = [
    {
      title: "Секрет 1:",
      description: "Контент с ценностью — посты, которые решают проблемы.",
      icon: "💎",
    },
    {
      title: "Секрет 2:",
      description: "Прогрев аудитории — 5-7 постов перед продажей.",
      icon: "🔥",
    },
    {
      title: "Секрет 3:",
      description: "Простой продукт для ЦА — PDF-гайд за 500-1000 рублей.",
      icon: "💰",
    },
    {
      title: "Секрет 4:",
      description: "Активность — отвечай на комментарии, запускай опросы.",
      icon: "⚡",
    },
  ];
